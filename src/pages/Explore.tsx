      ...
      <section className="relative pt-32 pb-20 overflow-hidden flex-1">
        ...
        <div className="relative z-10 container mx-auto px-4">
          <div className="text-center mb-20 animate-fade-in">
            ...
            <h1 className="font-display text-7xl md:text-9xl font-bold uppercase tracking-wider mb-8">
              Explore
            </h1>
            <p className="font-mono text-base text-muted-foreground max-w-3xl mx-auto mb-12">
          ...
          {/* Categories Grid */}
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 max-w-7xl mx-auto mb-24">
            {categories.map((cat, index) => {
              ...
              return (
                <Link
                  key={cat.label}
                  to={cat.link}
                  className="group relative bg-card border-2 border-border hover:border-primary p-8 rounded-lg transition-all duration-500 hover:shadow-[0_0_30px_rgba(34,197,94,0.3)] cursor-pointer animate-fade-in hover:scale-105 transform"
                  style={{ animationDelay: `${index * 100}ms` }}
                >
                  <div className="text-center">
                    <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-primary/10 border-2 border-primary mb-6 group-hover:bg-primary group-hover:scale-110 transition-all duration-300">
                      <Icon className="w-10 h-10 text-primary group-hover:text-background transition-colors" />
                    </div>
